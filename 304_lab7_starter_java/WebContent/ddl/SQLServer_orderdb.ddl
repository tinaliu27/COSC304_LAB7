...
INSERT product(productName, categoryId, productDesc, productPrice) VALUES ('The One Eyed Rock',3,'1 kg pkg.',21.00);
...
UPDATE Product SET productImageURL = 'img/Santa.png' WHERE ProductId = 7;
